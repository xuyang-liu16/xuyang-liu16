🌈 I am Xuyang Liu (刘旭洋), an incoming PhD student at [PolyU](https://www.polyu.edu.hk/), where I will join the [VC Lab](https://polyu-vclab.github.io/) under the supervision of Chair Prof. [Lei Zhang](https://www4.comp.polyu.edu.hk/~cslzhang/) (IEEE Fellow). I am also currently working as a research intern at [OPPO Research Institute](https://www.oppo.com/uk/). Previously, I earned my M.S. from [Sichuan University](https://en.scu.edu.cn/) and spent a wonderful year interning at [Alibaba Group](https://x.com/AlibabaGroup) and [Ant Group](https://x.com/AntGroup). I am fortunate to work closely with Dr. [Siteng Huang](https://kyonhuang.top/) and Prof. [Linfeng Zhang](http://www.zhanglinfeng.tech/).

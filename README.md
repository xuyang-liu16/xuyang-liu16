...
* **Vision-language Learning**: visual grounding (VG) and [referring video object segmentation (R-VOS)](https://github.com/xuyang-liu16/Awesome-Video-Object-Segmentation).

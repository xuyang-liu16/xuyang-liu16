### Hi there, I'm Xuyang Liu (刘旭洋)! :sunglasses:
...
* **Vision-language Learning**: visual grounding (VG) and [referring video object segmentation (RVOS)](https://github.com/xuyang-liu16/Awesome-Video-Object-Segmentation).
...
:two_hearts: Please note, the profile picture depicts my lovely girlfriend **Xinying Lin (林欣莹)**, with whom I affectionately share the squared term (**lxy<sup>2</sup>**) from our identical English initials.
